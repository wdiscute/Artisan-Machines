...
{
    public DehydratorRecipe(List<Ingredient> ingredients, List<ChancedStack> result, int processing_hours)
    {
        super(ArtisanRecipeTypes.DEHYDRATOR.get(), ingredients, result, processing_hours);
    }

    @Override
    public ItemStack getToastSymbol()
    {
        return new ItemStack(ArtisanBlocks.DEHYDRATOR);
    }

    @Override
    public RecipeSerializer<?> getSerializer()
    {
        return ArtisanRecipeSerializers.DEHYDRATOR.get();
    }
