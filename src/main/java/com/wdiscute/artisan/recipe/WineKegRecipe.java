...
{
    public WineKegRecipe(List<Ingredient> ingredients, List<ChancedStack> result, int processing_hours)
    {
        super(ArtisanRecipeTypes.WINE_KEG.get(), ingredients, result, processing_hours);
    }
