...
{
    public CrystalariumRecipe(List<Ingredient> ingredients, List<ChancedStack> result, int processing_hours, List<ResourceLocation> requiredUpgrades)
    {
        super(ArtisanRecipeTypes.CRYSTALARIUM.get(), ingredients, result, processing_hours, requiredUpgrades);
    }
