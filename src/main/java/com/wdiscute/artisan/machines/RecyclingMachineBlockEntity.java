...
public class RecyclingMachineBlockEntity extends AbstractMachineBlockEntity
{
    public RecyclingMachineBlockEntity(BlockPos blockPos, BlockState blockState)
    {
        super(ArtisanBlockEntities.RECYCLING_MACHINE.get(), blockPos, blockState);
    }

    @Override
    public RecipeType<? extends AbstractArtisanRecipe> getRecipeType()
    {
        return ArtisanRecipeTypes.RECYCLING_MACHINE.get();
    }
}
